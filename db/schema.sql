...
CREATE TABLE IF NOT EXISTS user_category_performance (
    ...
    questions_success INTEGER DEFAULT 0,
    questions_total_pond DECIMAL(10, 2) DEFAULT 0,
    questions_success_pond DECIMAL(10, 2) DEFAULT 0,
    minimum_progress REAL DEFAULT 0,
    confidence INTEGER DEFAULT 1 CHECK (
        confidence >= 0
        AND confidence <= 5
    ),
...
-- Añadir comentarios para documentación de los nuevos campos
